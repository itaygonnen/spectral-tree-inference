...
has exactly two blocks and the Fiedler vector is constant on each clan
...
and its Fiedler vector, and the result that the Fiedler split is always a clan pair.
