...
primary split, the coherence of the leading invariant subspace, and the gap
...
Let $S$ satisfy \Cref{def:cfbm} at the primary split, as \Cref{prop:cfbm} guarantees
...
$\vv_i=+c_A$ for $i\in A$ and $\vv_i=-c_B$ for $i\in B$, with $c_A=\sqrt{b/(am)}$
and $c_B=\sqrt{a/(bm)}$; and (iii) consequently
...
the identity $(D_A-S_A)\1_a=b\bze\1_a$ holds for an arbitrary symmetric diagonal
