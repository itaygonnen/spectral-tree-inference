...
| **4** | `S_by_alpha.png`<br>`spectral_gap_bound.png` | `sections/appendix-D.tex` | `fig:hbm_spectral_verification` | `paper/fig04_hbm_spectral_gap.ipynb` | `prop:D-gap`, `prop:D-floor` |
| **5 (a-d)** | `Fiedler_Bipartitions/fiedler_tree_partition_eta01.png`<br>`Fiedler_Bipartitions/fiedler_tree_partition_eta05.png`<br>`Fiedler_Bipartitions/fiedler_tree_partition_eta10.png`<br>`Fiedler_Bipartitions/fiedler_tree_partition_eta15.png` | `sections/appendix-D.tex` | `fig:fiedler_partitions` | `paper/fig05_fiedler_partitions.ipynb` | `prop:coherence`, `lem:gap` |
| **6** | `pstar_balanced_nmi.png` | `sections/appendix-emp.tex` | `fig:pstar_balanced` | `paper/fig06_pstar_balanced.ipynb` | `thm:main-sim` |
| **7** | `identity_scatter_kingman.png` | `sections/appendix-emp.tex` | `fig:identity_gen` | `paper/fig07_identity_checks.ipynb` | `prop:coherence`, `lem:gap` |
| **8** | `recovery_grid_kmeans.png` | `sections/appendix-emp.tex` | `fig:recovery_grid` | `paper/fig03_pstar_gen_kingman.ipynb` | `thm:main-sim` |
| **9** | `pstar_gen_3operators.png` | `sections/appendix-emp.tex` | `fig:operator_sensitivity` | `paper/fig03_pstar_gen_kingman.ipynb` | — |
...
|---|---|---|
| `supporting/distance_vs_similarity_generated.ipynb` | App F / thm:main-dist (the distance route, which has NO figure) | live evidence; generated twin of the real-data notebook |
...
| `supporting/nj_subsampling_balanced.ipynb` | distance-route context: NJ under sub-sampling | exploratory - not cited; outputs cleared |
| `supporting/nj_subsampling_nonbalanced.ipynb` | distance-route context: NJ on unbalanced birth-death trees | exploratory - not cited; cell 15 LAUNCHES an n=4000 sweep |
| `supporting/snj_subsampling.ipynb` | SNJ sigma2 separation / RF distance vs p | exploratory - not cited; outputs cleared |
| `supporting/subsample_S_vs_subsample_D.ipynb` | sub-sampling S directly vs sub-sampling D then S=exp(-alpha*D) | exploratory - not cited; outputs cleared |
...
| `supporting/pstar_flat_cbm_distance.ipynb` | App F / thm:main-dist -- Griffing B=HDH mirror of Fig 2 on synthesized flat CBM | live; NOT in the manuscript |
| `supporting/pstar_eta_pool_distance.ipynb` | App F / thm:main-dist -- Griffing B=HDH mirror of Fig 3 on the eta pool; note it is NOT like-for-like with Fig 3 | live; NOT in the manuscript |
